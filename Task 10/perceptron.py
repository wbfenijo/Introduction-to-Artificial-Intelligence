...
class SingleLayerPerceptron:
    ...
    def train(self, inputs, targets, num_epochs, alpha=0.05):
...
if __name__ == "__main__":
    ...
    training_history = model.train(all_inputs, all_targets, num_epochs=300, alpha=0.1)  # feel free to add epochs
